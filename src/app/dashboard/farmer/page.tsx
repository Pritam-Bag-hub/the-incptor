          ...
          <div className="bg-white rounded-3xl border border-brandy/30 shadow-2xl p-6 sm:p-8 max-w-lg w-full relative space-y-6 my-8 animate-in slide-in-from-bottom-4 duration-300">
            ...
            {loadingViewingContract ? (
              ...
              <div className="space-y-6">
                ...
                {/* 1. Yield & Fulfillment Card with Harvest Submission */}
                ...
                {/* 2. Read-only Financial Allocation Card for Landowner */}
                {viewingContractOverview?.financialSummary && (
                  <div className="bg-brandy/5 border border-brandy/20 p-5 rounded-2xl space-y-3 animate-in fade-in text-xs">
                    <div className="flex justify-between items-center">
                      <h4 className="text-xs font-bold text-pine uppercase tracking-wider">Financial Breakdown</h4>
                      <span className={`text-[10px] px-2 py-0.5 rounded font-bold uppercase ${
                    ...
                    <div className="grid grid-cols-2 gap-3 bg-white/60 p-4 rounded-xl border border-brandy/10">
                      <div>
                        <span className="text-[10px] text-kombu/60 block">Your Payment (Landowner Amount)</span>
                        <span className="font-bold text-pine text-sm">₹{viewingContractOverview.financialSummary.landownerAmount.toLocaleString("en-IN")}</span>
                      </div>
                      <div>
                      ...
                      <div className="col-span-2 border-t border-brandy/25 pt-2">
                        <span className="text-[10px] text-kombu/60 block">Total agreed contract budget value</span>
                        <span className="font-bold text-copper">₹{viewingContractOverview.financialSummary.totalContractValue.toLocaleString("en-IN")}</span>
                      </div>
                    </div>
                  </div>
                )}
